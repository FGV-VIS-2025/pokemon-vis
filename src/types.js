export function renderTypeChord(containerSelector, width = 960, height = 960) {
  ...
  Promise.all([
    ...
    d3.csv("../data/pokemon_types.csv")
  ]).then(([types, pokemonTypes]) => {
    const typeIdToName = {};
    types.forEach(d => {
    ...
    const pokemonMap = d3.group(pokemonTypes, d => d.pokemon_id);
