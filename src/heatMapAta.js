...
export function createHeatMapAta(selectedPokemons) {
    d3.select(".svg-chart-3").selectAll("*").remove();

    const heatSvg = document.getElementsByClassName("svg-chart-3")[0];
    const heatPaiSvg = document.getElementsByClassName("svg-pai-chart-3")[0];
    ...
    const svg = d3.select(".svg-chart-3")
    .append("svg")
    .attr("width", svgWidth)
